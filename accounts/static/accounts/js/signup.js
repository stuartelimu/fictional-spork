...
RFORM.addEventListener('submit', (e) => {
  ...
  RFORM.querySelector('button').setAttribute('disabled', 'true');

  const FNAME = RFORM.querySelector('input[name="FName"]');
  const LNAME = RFORM.querySelector('input[name="LName"]');

  const EMAIL = RFORM.querySelector('input[name="Email"]');
  const PHONE = RFORM.querySelector('input[name="Phone_no"]').value;
  ...
  fetch('connect.php', {
    ...
    console.log(data);
    RFORM.querySelector('button').removeAttribute('disabled');
